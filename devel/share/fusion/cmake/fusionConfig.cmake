...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /root/catkin_ws/src/sdc_hw4/HW4_Student/src/fusion)
  set(fusion_DEVEL_PREFIX /root/catkin_ws/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/sdc_hw4/HW4_Student/src/fusion/${idir}'.  ${_report}")
    endif()
