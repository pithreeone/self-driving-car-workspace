...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /root/catkin_ws/src/fusion)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/fusion/${idir}'.  ${_report}")
    endif()
